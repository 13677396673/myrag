...
> 最后更新：2026-06-20 (Phase 4 M15/M26 重构为策略路由架构 ✅)
> 总模块数：27 个后端模块 + 前端 + 部署
...
| M11 | Embedding | [module-embeddings.md](module-embeddings.md) | Phase 3 | ✅ 已完成 | P0 |
| M12 | 向量存储 | [module-vector-stores.md](module-vector-stores.md) | Phase 3 | ✅ 已完成 | P0 |
...
| M26 | 文档 Chunking 策略 | [module-strategies.md](module-strategies.md) | Phase 4 | ✅ 已完成 | P0 |
...
| M21 | 管理后台服务 | [module-admin-service.md](module-admin-service.md) | Phase 5 | ✅ 已完成 | P1 |
...
| F01 | 前端开发 | [module-frontend.md](module-frontend.md) | Phase 8 | ✅ 已完成 | P0 |
| D01 | 部署与文档 | [module-deployment.md](module-deployment.md) | Phase 9 | ✅ 已完成 | P1 |
